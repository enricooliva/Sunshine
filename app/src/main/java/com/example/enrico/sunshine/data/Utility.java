package com.example.enrico.sunshine.data;

/**
 * Created by Enrico on 09/02/2015.
 */
...
// back into date objects for comparison/processing.
    ...
    public static boolean isNotificationOn(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        return prefs.getBoolean(context.getString(R.string.pref_notification),true);
    }
    ...
    public static String dbDate(String formatDate){
        try {
            Date date =  DateFormat.getDateInstance().parse(formatDate);
            return WeatherContract.getDbDateString(date);
