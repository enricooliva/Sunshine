...
public class WeatherContract {
    ...
    public static final String CONTENT_AUTHORITY = "com.example.enrico.sunshine.app";
    ...
    public static final class LocationEntry implements BaseColumns {
        ...
        public static Uri buildLocationWithCityName(
                String locationSetting, String cityName) {
            return CONTENT_URI.buildUpon().appendPath(locationSetting)
                    .appendQueryParameter(COLUMN_CITY_NAME, cityName).build();
        }
